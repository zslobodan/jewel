 ...
 * file size and retention periods. Key features include thread-safe logging
 * operations, automatic log
 * rotation when size limit is reached, automatic cleanup of old log files,
